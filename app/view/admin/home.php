	...
	<table>
		<tbody>
			<tr>
				<td style="width: 30%">
					<div class="card">
					<?php echo "<img src='/Slipstream_HRM_System/app/view/Images/User_Images/".$userList['user_image']."' alt='".$userList['name']."' style='width: 70%' align='center'>"; ?>
					  <div class="container">
				...
				<td>
					<div class='slideshow-container'>
						...
						<div class='mySlides fade'>
							...
							<div class='text'>Working Lab</div>
						</div>
...
<tr>
<td>
    <a href="/Slipstream_HRM_System/?admin_leave_asign">
  <img src="http://localhost/Slipstream_HRM_System/app/view/Images/App_Theme/ApplyLeave.png" alt="Assign Leave" style="width:42px;height:42px;border:0;">
</a> &nbsp &nbsp <br><b> Assign Leave</b>
  </td>  
  <td>
   &nbsp &nbsp <a href="/Slipstream_HRM_System/?admin_leave_show">
  <img src="http://localhost/Slipstream_HRM_System/app/view/Images/App_Theme/MyLeave.png" alt="Assign Leave" style="width:42px;height:42px;border:0;">
</a> &nbsp &nbsp <br><b>&nbsp &nbsp Leave List</b>
</td>
 <td>
     &nbsp &nbsp <a href="/Slipstream_HRM_System/?admin_project_show">
  <img src="http://localhost/Slipstream_HRM_System/app/view/Images/App_Theme/MyTimesheet.png" alt="Assign Leave" style="width:42px;height:42px;border:0;">
